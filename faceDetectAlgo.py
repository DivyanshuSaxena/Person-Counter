...
prof_cascade = cv2.CascadeClassifier('G:\DISA\opencv\sources\data\haarcascades\haarcascade_profileface.xml')
...
for imagePath in paths.list_images(args["images"]):
    ...
    faces1 = face1_cascade.detectMultiScale(gray, 1.05, minNeighbors=3, minSize=(20,20))
    ...
    prof = prof_cascade.detectMultiScale(gray, 1.075, minNeighbors=3, minSize=(20,20))
